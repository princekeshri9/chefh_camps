        ...
        <ul style={{listStyleType: "none", overflow: "hidden", margin: "0", padding: "0"}}>
          ...
          <li style={{padding: "10px", float: "right"}}>
						...
						<ul style={{listStyleType: "none", padding: "10px 0px", textAlign: "center"}}>
							...
							<br />
							<li style={{display: "inline-block", marginRight: "10px"}}><a href="https://www.facebook.com/profile.php?id=100005439619169" target="_blank" rel="noopener noreferrer"><svg version="1.1" id="Capa_1" width="25px" height="25px" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"	 viewBox="0 0 112.196 112.196" enableBackground="new 0 0 112.196 112.196"><g>	<circle fill="#3B5998" cx="56.098" cy="56.098" r="56.098"/>	<path fill="#FFFFFF" d="M70.201,58.294h-10.01v36.672H45.025V58.294h-7.213V45.406h7.213v-8.34		c0-5.964,2.833-15.303,15.301-15.303L71.56,21.81v12.51h-8.151c-1.337,0-3.217,0.668-3.217,3.513v7.585h11.334L70.201,58.294z"/></g></svg></a></li>
							<li style={{display: "inline-block"}}><a href="mailto:princeviratkeshri@gmail.com" target="_blank" rel="noopener noreferrer"><img alt="mail" src={gmailLogo} width="25px" height="25px" /></a></li>
						</ul>
					</li>
        </ul>
				<hr width="700px"  style={{margin: "0px"}}/>
				{/* eslint-disable-next-line */}
				<div style={{padding: "10px"}}><small>Made with <span style={{color: "#ff0000"}}>❤</span> by <a href="https://www.linkedin.com/in/princekeshri9/" target="_blank" rel="noopener noreferrer" style={(this.props.userDetails.themeBool == 0 ? {color:"white"} : {color:"black"})}>Prince</a> © 2020</small></div>
      </div>
    );
  }
}
